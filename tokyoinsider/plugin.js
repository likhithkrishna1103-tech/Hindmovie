(function () {
    ...
    async function getHome(cb) {
        try {
            ...
            Analytics.logEvent('tokyoinsider_home', {});
    ...
    async function search(query, cb) {
        try {
            ...
            Analytics.logEvent('tokyoinsider_search', {});
    ...
    async function load(url, cb) {
        try {
            ...
            Analytics.logEvent('tokyoinsider_load', {});
    ...
    async function loadStreams(url, cb) {
        try {
            ...
            Analytics.logEvent('tokyoinsider_loadstreams', {});
