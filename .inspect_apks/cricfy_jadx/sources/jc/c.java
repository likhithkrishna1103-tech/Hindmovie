...
public final class c {
    ...
    public static final String[] f6742c = {"*", "FCM", "GCM", ""};
    ...
    */
    public c(ab.g r4) {
        /*
            ...
            r3.<init>()
            r4.a()
            android.content.Context r0 = r4.f390a
            ...
            r4.a()
            ab.j r0 = r4.f392c
            java.lang.String r1 = r0.f407e
            if (r1 == 0) goto L1b
            goto L48
        L1b:
            r4.a()
            java.lang.String r1 = r0.f404b
        ...
        L48:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: jc.c.<init>(ab.g):void");
    }

    public final String a() {
        String string;
        synchronized (this.f6743a) {
            string = this.f6743a.getString("|S|id", null);
        }
        return string;
    }
    ...
    public final String b() {
        ...
        synchronized (this.f6743a) {
            ...
            String string = this.f6743a.getString("|S||P|", null);
            if (string == null) {
                return null;
            }
            try {
