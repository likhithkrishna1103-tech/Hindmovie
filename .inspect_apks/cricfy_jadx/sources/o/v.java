...
public class v extends ImageButton {
    ...
    public final ff.k f9376v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    public final f3.a f9377w;
    ...
    public final void drawableStateChanged() {
        ...
        ff.k kVar = this.f9376v;
        if (kVar != null) {
            kVar.b();
        }
        f3.a aVar = this.f9377w;
        if (aVar != null) {
            aVar.b();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        return !(((ImageView) this.f9377w.f3936x).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        f3.a aVar = this.f9377w;
        if (aVar != null && drawable != null && !this.f9378x) {
