...
public abstract class a {
    ...
    public static final int[] f8302a = {R.attr.name, R.attr.tint, R.attr.height, R.attr.width, R.attr.alpha, R.attr.autoMirrored, R.attr.tintMode, R.attr.viewportWidth, R.attr.viewportHeight};

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final int[] f8303b = {R.attr.name, R.attr.pivotX, R.attr.pivotY, R.attr.scaleX, R.attr.scaleY, R.attr.rotation, R.attr.translateX, R.attr.translateY};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final int[] f8304c = {R.attr.name, R.attr.fillColor, R.attr.pathData, R.attr.strokeColor, R.attr.strokeWidth, R.attr.trimPathStart, R.attr.trimPathEnd, R.attr.trimPathOffset, R.attr.strokeLineCap, R.attr.strokeLineJoin, R.attr.strokeMiterLimit, R.attr.strokeAlpha, R.attr.fillAlpha, R.attr.fillType};

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final int[] f8305d = {R.attr.name, R.attr.pathData, R.attr.fillType};

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final int[] f8306e = {R.attr.drawable};
    public static final int[] f = {R.attr.name, R.attr.animation};

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static final int[] f8307g = {R.attr.interpolator, R.attr.duration, R.attr.startOffset, R.attr.repeatCount, R.attr.repeatMode, R.attr.valueFrom, R.attr.valueTo, R.attr.valueType};

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public static final int[] f8308h = {R.attr.ordering};
    public static final int[] i = {R.attr.valueFrom, R.attr.valueTo, R.attr.valueType, R.attr.propertyName};

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public static final int[] f8309j = {R.attr.value, R.attr.interpolator, R.attr.valueType, R.attr.fraction};

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public static final int[] f8310k = {R.attr.propertyName, R.attr.pathData, R.attr.propertyXName, R.attr.propertyYName};
    ...
    */
    public static android.animation.Animator a(android.content.Context r27, android.content.res.Resources r28, android.content.res.Resources.Theme r29, org.xmlpull.v1.XmlPullParser r30, android.util.AttributeSet r31, android.animation.AnimatorSet r32, int r33) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: m5.a.a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.animation.AnimatorSet, int):android.animation.Animator");
    }
    ...
    public static PropertyValuesHolder b(TypedArray typedArray, int i10, int i11, int i12, String str) {
        ...
        if (i10 == 2) {
            ...
            l0.f[] fVarArrM = u8.a.m(string);
            l0.f[] fVarArrM2 = u8.a.m(string2);
            if (fVarArrM != null || fVarArrM2 != null) {
                if (fVarArrM != null) {
                    ba.h hVar = new ba.h(1);
                    if (fVarArrM2 == null) {
                        return PropertyValuesHolder.ofObject(str, hVar, fVarArrM);
                    }
                    if (u8.a.e(fVarArrM, fVarArrM2)) {
                        return PropertyValuesHolder.ofObject(str, hVar, fVarArrM, fVarArrM2);
                    }
                    throw new InflateException(" Can't morph from " + string + " to " + string2);
                }
                if (fVarArrM2 != null) {
                    return PropertyValuesHolder.ofObject(str, new ba.h(1), fVarArrM2);
                }
            }
            return null;
        }
        e eVar = i10 == 3 ? e.f8320a : null;
        if (z12) {
            if (z10) {
    ...
    public static ValueAnimator d(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ObjectAnimator objectAnimator, XmlPullParser xmlPullParser) {
        ...
        TypedArray typedArrayG = k0.b.g(resources, theme, attributeSet, f8307g);
        TypedArray typedArrayG2 = k0.b.g(resources, theme, attributeSet, f8310k);
        ValueAnimator valueAnimator3 = objectAnimator == null ? new ValueAnimator() : objectAnimator;
        long j4 = k0.b.d(xmlPullParser, "duration") ? typedArrayG.getInt(1, 300) : 300;
        ...
        if (xmlPullParser.getAttributeValue("http://schemas.android.com/apk/res/android", "valueFrom") != null && xmlPullParser.getAttributeValue("http://schemas.android.com/apk/res/android", "valueTo") != null) {
            if (i11 == 4) {
                ...
                boolean z11 = typedValuePeekValue2 != null;
                i11 = ((z10 && c(i12)) || (z11 && c(z11 ? typedValuePeekValue2.type : 0))) ? 3 : 0;
            }
        ...
        if (typedArrayG2 != null) {
            ...
            String strC = k0.b.c(typedArrayG2, xmlPullParser, "pathData", 1);
            if (strC != null) {
                String strC2 = k0.b.c(typedArrayG2, xmlPullParser, "propertyXName", 2);
                String strC3 = k0.b.c(typedArrayG2, xmlPullParser, "propertyYName", 3);
                if (i11 != 2) {
                }
                ...
                valueAnimator = valueAnimator3;
                i10 = 0;
                objectAnimator2.setPropertyName(k0.b.c(typedArrayG2, xmlPullParser, "propertyName", 0));
            }
        } else {
            valueAnimator = valueAnimator3;
            i10 = 0;
