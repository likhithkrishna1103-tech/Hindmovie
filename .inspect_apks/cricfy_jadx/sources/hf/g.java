...
public abstract class g {
    ...
    public static int SmoothBottomBar_cornerRadius = 2;
    public static int SmoothBottomBar_corners = 3;
    public static int SmoothBottomBar_duration = 4;
    public static int SmoothBottomBar_iconMargin = 5;
    public static int SmoothBottomBar_iconSize = 6;
    public static int SmoothBottomBar_iconTint = 7;
    public static int SmoothBottomBar_iconTintActive = 8;
    public static int SmoothBottomBar_indicatorColor = 9;
    public static int SmoothBottomBar_indicatorRadius = 10;
    public static int SmoothBottomBar_itemFontFamily = 11;
    public static int SmoothBottomBar_itemPadding = 12;
    public static int SmoothBottomBar_menu = 13;
    public static int SmoothBottomBar_sideMargins = 14;
    public static int SmoothBottomBar_textColor = 15;
    public static int SmoothBottomBar_textSize = 16;
    ...
    public static int[] NavAction = {android.R.attr.id, R.attr.destination, R.attr.enterAnim, R.attr.exitAnim, R.attr.launchSingleTop, R.attr.popEnterAnim, R.attr.popExitAnim, R.attr.popUpTo, R.attr.popUpToInclusive};
