...
public class k {
    ...
    public static final /* synthetic */ AtomicReferenceFieldUpdater f12473a = AtomicReferenceFieldUpdater.newUpdater(k.class, Object.class, "_cur$volatile");
    private volatile /* synthetic */ Object _cur$volatile = new m(8, false);

    public final boolean a(Runnable runnable) {
        while (true) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f12473a;
    ...
    public final int c() {
        m mVar = (m) f12473a.get(this);
        mVar.getClass();
        long j4 = m.f.get(mVar);
