...
public final class r implements Parcelable {
    ...
    public static final v.e f7753x;

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    public static final String[] f7754y;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public final Bundle f7755v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    public MediaMetadata f7756w;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        parcel.writeBundle(this.f7755v);
    }

    public r(Parcel parcel) {
        Bundle bundle = parcel.readBundle(c0.class.getClassLoader());
        bundle.getClass();
        this.f7755v = bundle;
    }
}
