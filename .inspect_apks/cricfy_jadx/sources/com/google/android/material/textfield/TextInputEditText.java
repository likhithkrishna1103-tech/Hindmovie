...
public class TextInputEditText extends t {
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet) {
        int i = a.editTextStyle;
        super(ra.a.a(context, attributeSet, i, 0), attributeSet, i);
        this.B = new Rect();
        TypedArray typedArrayD = d0.d(context, attributeSet, l.TextInputEditText, i, k.Widget_Design_TextInputEditText, new int[0]);
    ...
    public CharSequence getHint() {
        TextInputLayout textInputLayout = getTextInputLayout();
        return (textInputLayout == null || !textInputLayout.f2967d0) ? super.getHint() : textInputLayout.getHint();
    }
    ...
    public final void onAttachedToWindow() {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && textInputLayout.f2967d0 && super.getHint() == null) {
