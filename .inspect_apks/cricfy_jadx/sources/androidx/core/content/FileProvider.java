...
public class FileProvider extends ContentProvider {
    ...
    public final Object f655v = new Object();
    ...
    public static final String[] f653y = {"_display_name", "_size"};

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    public static final File f654z = new File("/");
    ...
    public static Uri d(Context context, String str, File file) {
        ...
        try {
            ...
            for (Map.Entry entry2 : dVarC.f5971b.entrySet()) {
            ...
            return new Uri.Builder().scheme("content").authority(dVarC.f5970a).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(path2.endsWith("/") ? canonicalPath.substring(path2.length()) : canonicalPath.substring(path2.length() + 1), "/")).build();
    ...
    public static d e(Context context, String str) throws XmlPullParserException, IOException {
        ...
        if (providerInfoResolveContentProvider == null) {
            throw new IllegalArgumentException(a.n("Couldn't find meta-data for provider with authority ", str));
        }
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if ("root-path".equals(name)) {
                    externalStorageDirectory = f654z;
                ...
                if (externalStorageDirectory == null) {
                    ...
                    try {
                        dVar.f5971b.put(attributeValue, externalStorageDirectory.getCanonicalFile());
                    } catch (IOException e9) {
    ...
    public final d b() {
        ...
        synchronized (this.f655v) {
            try {
                ...
                if (this.f657x == null) {
                    this.f657x = c(getContext(), this.f656w);
                }
                dVar = this.f657x;
            } catch (Throwable th) {
                throw th;
    ...
    public final ParcelFileDescriptor openFile(Uri uri, String str) {
        ...
        if ("r".equals(str)) {
            ...
            if (!"rwt".equals(str)) {
                throw new IllegalArgumentException(a.n("Invalid mode: ", str));
            }
            i = 1006632960;
        }
