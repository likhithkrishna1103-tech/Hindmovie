...
public final class a extends View.AccessibilityDelegate {
    ...
    public final boolean dispatchPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
        return this.f11723a.a(view, accessibilityEvent);
    }

    @Override // android.view.View.AccessibilityDelegate
    public final AccessibilityNodeProvider getAccessibilityNodeProvider(View view) {
        kf.i iVarB = this.f11723a.b(view);
        if (iVarB != null) {
            return (AccessibilityNodeProvider) iVarB.f7483w;
        }
        return null;
    }
    ...
    public final void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
        this.f11723a.c(view, accessibilityEvent);
    }
    ...
    public final void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        Object tag3;
        int iKeyAt;
        u0.e eVar = new u0.e(accessibilityNodeInfo);
        WeakHashMap weakHashMap = m0.f11777a;
        int i = g0.c.tag_screen_reader_focusable;
        if (Build.VERSION.SDK_INT >= 28) {
            tag = Boolean.valueOf(h0.c(view));
        } else {
            tag = view.getTag(i);
        ...
        int i12 = g0.c.tag_accessibility_heading;
        if (Build.VERSION.SDK_INT >= 28) {
            tag2 = Boolean.valueOf(h0.b(view));
        } else {
        ...
        CharSequence charSequenceE = m0.e(view);
        if (i11 >= 28) {
        ...
        int i13 = g0.c.tag_state_description;
        ...
        if (i11 >= 30) {
            m0.a.e(accessibilityNodeInfo, charSequence);
        } else {
            accessibilityNodeInfo.getExtras().putCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.STATE_DESCRIPTION_KEY", charSequence);
        }
        this.f11723a.d(view, eVar);
        ...
        if (i11 < 26) {
            ...
            if (clickableSpanArr != null && clickableSpanArr.length > 0) {
                accessibilityNodeInfo.getExtras().putInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY", g0.c.accessibility_action_clickable_span);
                SparseArray sparseArray2 = (SparseArray) view.getTag(g0.c.tag_accessibility_clickable_spans);
                if (sparseArray2 == null) {
                    sparseArray2 = new SparseArray();
                    view.setTag(g0.c.tag_accessibility_clickable_spans, sparseArray2);
                }
                int i16 = 0;
        ...
        for (int i18 = 0; i18 < list.size(); i18++) {
            eVar.b((u0.c) list.get(i18));
        }
    }

    @Override // android.view.View.AccessibilityDelegate
    public final void onPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
        this.f11723a.e(view, accessibilityEvent);
    }

    @Override // android.view.View.AccessibilityDelegate
    public final boolean onRequestSendAccessibilityEvent(ViewGroup viewGroup, View view, AccessibilityEvent accessibilityEvent) {
        return this.f11723a.f(viewGroup, view, accessibilityEvent);
    }

    @Override // android.view.View.AccessibilityDelegate
    public final boolean performAccessibilityAction(View view, int i, Bundle bundle) {
        return this.f11723a.g(view, i, bundle);
    }

    @Override // android.view.View.AccessibilityDelegate
    public final void sendAccessibilityEvent(View view, int i) {
        this.f11723a.h(view, i);
    }

    @Override // android.view.View.AccessibilityDelegate
    public final void sendAccessibilityEventUnchecked(View view, AccessibilityEvent accessibilityEvent) {
        this.f11723a.i(view, accessibilityEvent);
    }
}
