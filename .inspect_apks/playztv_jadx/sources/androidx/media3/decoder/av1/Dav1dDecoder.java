...
public final class Dav1dDecoder implements d {
    ...
    public Dav1dDecoder(int i, int i10, int i11, int i12, int i13, boolean z2) throws b {
        ...
        for (int i15 = 0; i15 < this.availableOutputBufferCount; i15++) {
            this.availableOutputBuffers[i15] = new VideoDecoderOutputBuffer(new nc.c(21, this));
        }
    ...
    public native int dav1dCheckError(long j5);

    /* JADX INFO: Access modifiers changed from: private */
    public native void dav1dClose(long j5);

    private native int dav1dDecode(long j5, DecoderInputBuffer decoderInputBuffer, int i, int i10, boolean z2, int i11, long j8, int i12);

    private native void dav1dFlush(long j5);

    /* JADX INFO: Access modifiers changed from: private */
    public native String dav1dGetErrorMessage(long j5);

    private native int dav1dGetFrame(long j5, VideoDecoderOutputBuffer videoDecoderOutputBuffer);

    /* JADX INFO: Access modifiers changed from: private */
    public native long dav1dInit(int i, int i10, boolean z2);

    private native void dav1dReleaseFrame(long j5, VideoDecoderOutputBuffer videoDecoderOutputBuffer);

    private native int dav1dRenderFrame(long j5, Surface surface, VideoDecoderOutputBuffer videoDecoderOutputBuffer);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public native void releaseUnusedInputBuffers(long j5, Dav1dDecoder dav1dDecoder);
    ...
    public final void queueInputBuffer(DecoderInputBuffer decoderInputBuffer) {
        synchronized (this.lock) {
            maybeThrowException();
            q1.c.h(decoderInputBuffer == this.dequeuedInputBuffer);
