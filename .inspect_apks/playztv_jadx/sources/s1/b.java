...
public abstract class b {
    ...
    public static ExecutorService f11645a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final Object f11646b = new Object();
    ...
    public static void d(String str, boolean z2) throws k {
        if (!z2) {
            throw new k(str);
        }
    }
    ...
    public static synchronized Executor i() {
        try {
            if (f11645a == null) {
                int i = b0.f11647a;
                f11645a = Executors.newSingleThreadExecutor(new androidx.emoji2.text.a("ExoPlayer:BackgroundExecutor", 1));
            }
        } catch (Throwable th) {
            throw th;
        }
    ...
    public static String m(StringBuilder sb2, int i, int i10) {
        int i11;
        int iLastIndexOf;
        if (i >= i10) {
            return sb2.toString();
    ...
    public static String n(String str, String str2) {
        ...
        if (iArrJ[0] != -1) {
            sb2.append(str2);
            m(sb2, iArrJ[1], iArrJ[2]);
            return sb2.toString();
        }
        int[] iArrJ2 = j(str);
        if (iArrJ[3] == 0) {
            sb2.append((CharSequence) str, 0, iArrJ2[3]);
            sb2.append(str2);
            return sb2.toString();
        }
        if (iArrJ[2] == 0) {
            sb2.append((CharSequence) str, 0, iArrJ2[2]);
            sb2.append(str2);
            return sb2.toString();
        }
        int i = iArrJ[1];
        if (i != 0) {
            ...
            sb2.append(str2);
            return m(sb2, iArrJ[1] + i10, i10 + iArrJ[2]);
        }
        if (str2.charAt(i) == '/') {
            sb2.append((CharSequence) str, 0, iArrJ2[1]);
            sb2.append(str2);
            int i11 = iArrJ2[1];
            return m(sb2, i11, iArrJ[2] + i11);
        }
        int i12 = iArrJ2[0] + 2;
        int i13 = iArrJ2[1];
        if (i12 >= i13 || i13 != iArrJ2[2]) {
            ...
            sb2.append(str2);
            return m(sb2, iArrJ2[1], i14 + iArrJ[2]);
        }
        sb2.append((CharSequence) str, 0, i13);
        sb2.append('/');
        sb2.append(str2);
        int i15 = iArrJ2[1];
        return m(sb2, i15, iArrJ[2] + i15 + 1);
    }
