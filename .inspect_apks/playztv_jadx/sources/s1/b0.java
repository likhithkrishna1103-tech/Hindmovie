...
public abstract class b0 {
    ...
    public static final int f11647a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final String f11648b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final byte[] f11649c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final long[] f11650d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final Pattern f11651e;
    public static final Pattern f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static final Pattern f11652g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public static final Pattern f11653h;
    public static HashMap i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public static final String[] f11654j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public static final String[] f11655k;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public static final int[] f11656l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public static final int[] f11657m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public static final int[] f11658n;
    ...
    static {
        ...
        f11648b = str + ", " + Build.MODEL + ", " + str2 + ", " + i10;
        f11649c = new byte[0];
        f11650d = new long[0];
        f11651e = Pattern.compile("(\\d\\d\\d\\d)\\-(\\d\\d)\\-(\\d\\d)[Tt](\\d\\d):(\\d\\d):(\\d\\d)([\\.,](\\d+))?([Zz]|((\\+|\\-)(\\d?\\d):?(\\d\\d)))?");
        f = Pattern.compile("^(-)?P(([0-9]*)Y)?(([0-9]*)M)?(([0-9]*)D)?(T(([0-9]*)H)?(([0-9]*)M)?(([0-9.]*)S)?)?$");
        f11652g = Pattern.compile("%([A-Fa-f0-9]{2})");
        f11653h = Pattern.compile("(?:.*\\.)?isml?(?:/(manifest(.*))?)?", 2);
    ...
    public static p1.q A(int i10, int i11, int i12) {
        p1.p pVar = new p1.p();
    ...
    public static long B(long j5, float f4) {
        return f4 == 1.0f ? j5 : Math.round(j5 / ((double) f4));
    }

    public static String C(StringBuilder sb2, Formatter formatter, long j5) {
    ...
    public static String D(String str) {
        try {
            ...
            b.h("Util", "Failed to read system property ".concat(str), e10);
            return null;
        }
    }
    ...
    public static String E(int i10) {
        switch (i10) {
            ...
            default:
                return i10 >= 10000 ? e6.j.j(i10, "custom (", ")") : "?";
        }
    }
    ...
    */
    public static boolean F(p1.w0 r4) {
        /*
            r0 = 0
            if (r4 != 0) goto L4
            return r0
        ...
        L2e:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: s1.b0.F(p1.w0):boolean");
    }
    ...
    */
    public static int G(android.net.Uri r7, java.lang.String r8) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: s1.b0.G(android.net.Uri, java.lang.String):int");
    }

    public static boolean H(u uVar, u uVar2, Inflater inflater) {
        if (uVar.a() == 0) {
            return false;
        }
        if (uVar2.f11709a.length < uVar.a()) {
            uVar2.c(uVar.a() * 2);
        }
        if (inflater == null) {
            inflater = new Inflater();
        }
        inflater.setInput(uVar.f11709a, uVar.f11710b, uVar.a());
        int iInflate = 0;
        while (true) {
            try {
    ...
    public static boolean K(Context context) {
        ...
        if (i10 == 30) {
            ...
            if (com.bumptech.glide.d.j(str, "moto g(20)") || com.bumptech.glide.d.j(str, "rmx3231")) {
                return true;
            }
        }
        return i10 == 34 && com.bumptech.glide.d.j(Build.MODEL, "sm-x200");
    }
    ...
    public static String P(String str) {
        ...
        String strX = com.bumptech.glide.d.X(str);
        int i10 = 0;
        String str2 = strX.split("-", 2)[0];
        if (i == null) {
            String[] iSOLanguages = Locale.getISOLanguages();
            int length = iSOLanguages.length;
            String[] strArr = f11654j;
        ...
        if (str4 != null) {
            StringBuilder sbB = v.e.b(str4);
            sbB.append(strX.substring(str2.length()));
            strX = sbB.toString();
            str2 = str4;
        }
    ...
    public static long R(String str) throws n0 {
        Matcher matcher = f11651e.matcher(str);
        if (!matcher.matches()) {
    ...
    public static long U(int i10, long j5) {
        return W(j5, 1000000L, i10, RoundingMode.DOWN);
    }
    ...
    public static void V(long[] jArr, long j5) {
        ...
        if (j5 >= 1000000 && j5 % 1000000 == 0) {
            long jH = b8.h.h(j5, 1000000L, RoundingMode.UNNECESSARY);
            while (i10 < jArr.length) {
                jArr[i10] = b8.h.h(jArr[i10], jH, roundingMode);
                i10++;
            }
            return;
        }
        if (j5 < 1000000 && 1000000 % j5 == 0) {
            long jH2 = b8.h.h(1000000L, j5, RoundingMode.UNNECESSARY);
            while (i10 < jArr.length) {
                jArr[i10] = b8.h.A(jArr[i10], jH2);
                i10++;
            }
            return;
        }
        ...
        while (i11 < jArr.length) {
            ...
            if (j10 != 0) {
                if (j5 >= j10 && j5 % j10 == 0) {
                    jArr[i11] = b8.h.h(1000000L, b8.h.h(j5, j10, RoundingMode.UNNECESSARY), roundingMode);
                } else if (j5 >= j10 || j10 % j5 != 0) {
                    j8 = j5;
                    jArr[i11] = X(j10, 1000000L, j8, roundingMode);
                } else {
                    jArr[i11] = b8.h.A(1000000L, b8.h.h(j10, j5, RoundingMode.UNNECESSARY));
                }
                j8 = j5;
            } else {
                j8 = j5;
    ...
    public static long W(long j5, long j8, long j10, RoundingMode roundingMode) {
        if (j5 == 0 || j8 == 0) {
            return 0L;
        }
        return (j10 < j8 || j10 % j8 != 0) ? (j10 >= j8 || j8 % j10 != 0) ? (j10 < j5 || j10 % j5 != 0) ? (j10 >= j5 || j5 % j10 != 0) ? X(j5, j8, j10, roundingMode) : b8.h.A(j8, b8.h.h(j5, j10, RoundingMode.UNNECESSARY)) : b8.h.h(j8, b8.h.h(j10, j5, RoundingMode.UNNECESSARY), roundingMode) : b8.h.A(j5, b8.h.h(j8, j10, RoundingMode.UNNECESSARY)) : b8.h.h(j5, b8.h.h(j10, j8, RoundingMode.UNNECESSARY), roundingMode);
    }
    ...
    */
    public static long X(long r9, long r11, long r13, java.math.RoundingMode r15) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: s1.b0.X(long, long, long, java.math.RoundingMode):long");
    }

    public static boolean Y(w0 w0Var, boolean z2) {
        return w0Var == null || !w0Var.C() || w0Var.I() == 1 || w0Var.I() == 4 || !(!z2 || w0Var.s0() == 0 || w0Var.s0() == 4);
    }
    ...
    public static int a(long[] jArr, long j5, boolean z2) {
        int i10;
        ...
        while (true) {
            i10 = iBinarySearch + 1;
            if (i10 >= jArr.length || jArr[i10] != j5) {
                break;
            }
            iBinarySearch = i10;
        }
        return z2 ? iBinarySearch : i10;
    }

    public static e0 a0(ea.y yVar, ea.q qVar) {
        e0 e0Var = new e0();
        i0 i0Var = new i0(e0Var, 10, yVar);
        ea.r rVar = ea.r.f4628u;
        e0Var.f(i0Var, rVar);
        yVar.f(new g1(yVar, e0Var, qVar, 9), rVar);
        return e0Var;
    }

    public static int b(e6.i iVar, long j5) {
        ...
        int i13 = i10 + 1;
        if (i13 < iVar.f4522u && iVar.d(i13) == j5) {
            return i13;
        }
        if (i10 == -1) {
            return 0;
    ...
    public static int c(List list, Long l10, boolean z2) {
        int i10;
    ...
    public static int d(int[] iArr, int i10, boolean z2, boolean z10) {
        int i11;
        int i12;
    ...
    public static int e(long[] jArr, long j5, boolean z2) {
        int i10;
        int iBinarySearch = Arrays.binarySearch(jArr, j5);
        if (iBinarySearch < 0) {
            i10 = -(iBinarySearch + 2);
    ...
    public static long j(long j5, long j8, long j10) {
        return Math.max(j8, Math.min(j5, j10));
    }
    ...
    public static int m(int i10, int i11, int i12, byte[] bArr) {
        while (i10 < i11) {
            i12 = f11656l[((i12 >>> 24) ^ (bArr[i10] & 255)) & 255] ^ (i12 << 8);
            i10++;
        }
        return i12;
    }
    ...
    public static long x(long j5, float f4) {
        return f4 == 1.0f ? j5 : Math.round(j5 * ((double) f4));
    }
