...
public abstract class c {
    ...
    public static boolean a(double d10) {
        if (a.a.x(d10)) {
            return d10 == 0.0d || 52 - Long.numberOfTrailingZeros(a.a.s(d10)) <= Math.getExponent(d10);
        }
        return false;
    }

    public static boolean b(double d10) {
        if (d10 > 0.0d && a.a.x(d10)) {
            long jS = a.a.s(d10);
            if ((jS & (jS - 1)) == 0) {
                return true;
            }
    ...
    */
    public static int c(double r6) {
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: ca.c.c(double):int");
    }
}
