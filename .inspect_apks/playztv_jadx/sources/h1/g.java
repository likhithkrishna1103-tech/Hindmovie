...
public final class g {
    ...
    public static final boolean f5629l = Log.isLoggable("ExifInterface", 3);

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public static final int[] f5630m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public static final int[] f5631n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public static final byte[] f5632o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public static final byte[] f5633p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public static final byte[] f5634q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public static final byte[] f5635r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public static final byte[] f5636s;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    public static final byte[] f5637t;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    public static final byte[] f5638u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public static final byte[] f5639v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    public static final byte[] f5640w;

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    public static final byte[] f5641x;

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    public static final byte[] f5642y;

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    public static final byte[] f5643z;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final FileDescriptor f5644a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final AssetManager.AssetInputStream f5645b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public int f5646c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final HashMap[] f5647d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final HashSet f5648e;
    public ByteOrder f;
    ...
    static {
        ...
        f5630m = new int[]{8, 8, 8};
        f5631n = new int[]{8};
        f5632o = new byte[]{-1, -40, -1};
        f5633p = new byte[]{102, 116, 121, 112};
        f5634q = new byte[]{109, 105, 102, 49};
        f5635r = new byte[]{104, 101, 105, 99};
        f5636s = new byte[]{79, 76, 89, 77, 80, 0};
        f5637t = new byte[]{79, 76, 89, 77, 80, 85, 83, 0, 73, 73};
        f5638u = new byte[]{-119, 80, 78, 71, 13, 10, 26, 10};
        f5639v = new byte[]{101, 88, 73, 102};
        f5640w = new byte[]{73, 72, 68, 82};
        f5641x = new byte[]{73, 69, 78, 68};
        f5642y = new byte[]{82, 73, 70, 70};
        f5643z = new byte[]{87, 69, 66, 80};
        ...
        while (true) {
            ...
            if (i >= dVarArr6.length) {
                HashMap map = K;
                d[] dVarArr7 = G;
                map.put(Integer.valueOf(dVarArr7[0].f5623a), 5);
                map.put(Integer.valueOf(dVarArr7[1].f5623a), 1);
                map.put(Integer.valueOf(dVarArr7[2].f5623a), 2);
                map.put(Integer.valueOf(dVarArr7[3].f5623a), 3);
                map.put(Integer.valueOf(dVarArr7[4].f5623a), 7);
                map.put(Integer.valueOf(dVarArr7[5].f5623a), 8);
                Pattern.compile(".*[1-9].*");
            ...
            for (d dVar : dVarArr6[i]) {
                H[i].put(Integer.valueOf(dVar.f5623a), dVar);
                I[i].put(dVar.f5624b, dVar);
            }
            i++;
        }
    }
    ...
    */
    ...
    public final String b(String str) {
        ...
        if (cVarC != null) {
            ...
            if (str.equals("GPSTimeStamp")) {
                ...
                e eVar = eVarArr[0];
                Integer numValueOf = Integer.valueOf((int) (eVar.f5627a / eVar.f5628b));
                e eVar2 = eVarArr[1];
                Integer numValueOf2 = Integer.valueOf((int) (eVar2.f5627a / eVar2.f5628b));
                e eVar3 = eVarArr[2];
                return String.format("%02d:%02d:%02d", numValueOf, numValueOf2, Integer.valueOf((int) (eVar3.f5627a / eVar3.f5628b)));
            }
            try {
    ...
    public final c c(String str) {
        ...
        for (int i = 0; i < F.length; i++) {
            c cVar = (c) this.f5647d[i].get(str);
            if (cVar != null) {
                return cVar;
            }
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void e(h1.b r23, int r24, int r25) throws java.io.IOException {
        /*
    ...
    */
    ...
    public final void h(b bVar) throws IOException {
        ...
        bVar.f5616v = ByteOrder.BIG_ENDIAN;
        byte[] bArr = f5638u;
        bVar.a(bArr.length);
        ...
        while (true) {
            try {
                ...
                int i10 = length + 8;
                if (i10 == 16 && !Arrays.equals(bArr2, f5640w)) {
                    throw new IOException("Encountered invalid PNG file--IHDR chunk should appearas the first chunk");
                }
                if (Arrays.equals(bArr2, f5641x)) {
                    return;
                }
                if (Arrays.equals(bArr2, f5639v)) {
                    byte[] bArr3 = new byte[i];
                    if (bVar.read(bArr3) != i) {
                        throw new IOException("Failed to read given length for given PNG chunk type: " + q1.c.e(bArr2));
                    }
    ...
    public final void i(b bVar) throws IOException {
        ...
        bVar.a(i - bVar.f5617w);
        bVar.read(bArr4);
        e(new b(bArr4), i, 5);
        bVar.a(i11 - bVar.f5617w);
        bVar.f5616v = ByteOrder.BIG_ENDIAN;
    ...
    public final void k(f fVar) throws IOException {
        ...
        if (cVar != null) {
            e(new b(cVar.f5622d), (int) cVar.f5621c, 5);
        }
    ...
    public final void l(b bVar) throws IOException {
        ...
        bVar.f5616v = ByteOrder.LITTLE_ENDIAN;
        bVar.a(f5642y.length);
    ...
    public final void m(b bVar, HashMap map) throws IOException {
        ...
        if (iE > 0 && iE2 > 0 && this.f5645b == null && this.f5644a == null) {
            bVar.skip(iE);
    ...
    public final void o(f fVar) throws IOException {
        ...
        if (i10 < 8) {
            throw new IOException(j.l("Invalid first Ifd offset: ", i10));
        }
        int i11 = i10 - 8;
        if (i11 > 0) {
            fVar.a(i11);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void s(h1.f r36, int r37) throws java.io.IOException {
        /*
    ...
    public final void u(b bVar) throws IOException {
        ...
        if (cVar3 != null) {
            ...
            int[] iArr2 = f5630m;
            if (Arrays.equals(iArr2, iArr) || (this.f5646c == 3 && (cVar = (c) map.get("PhotometricInterpretation")) != null && (((iE = cVar.e(this.f)) == 1 && Arrays.equals(iArr, f5631n)) || (iE == 6 && Arrays.equals(iArr, iArr2))))) {
                c cVar4 = (c) map.get("StripOffsets");
                c cVar5 = (c) map.get("StripByteCounts");
                if (cVar4 == null || cVar5 == null) {
                    return;
                }
                long[] jArrP = q1.c.p(cVar4.g(this.f));
                long[] jArrP2 = q1.c.p(cVar5.g(this.f));
                ...
                int i = 0;
                int i10 = 0;
                for (int i11 = 0; i11 < jArrP.length; i11++) {
                    int i12 = (int) jArrP[i11];
                    int i13 = (int) jArrP2[i11];
                    if (i11 < jArrP.length - 1 && i12 + i13 != jArrP[i11 + 1]) {
                        this.f5649g = false;
                    }
                    int i14 = i12 - i;
                    if (i14 < 0) {
