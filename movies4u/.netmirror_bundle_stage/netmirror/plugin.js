(function () {
    ...
    function resolveProviderKey() {
        var providerId = trim((typeof manifest !== "undefined" && manifest && manifest.providerId) ? manifest.providerId : "");
        if (providerId && PROVIDER_CONFIGS[providerId]) return providerId;
