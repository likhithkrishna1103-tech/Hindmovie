...
const ROOT = "/data/data/com.termux/files/home/hindmovie/movies4u";
const STAGE_DIR = path.join(ROOT, ".netmirror_stage");

const PLUGINS = [
  {
    folder: "netmirror-netflix",
    packageName: "com.igris.repo.netmirrornetflix",
    name: "NetMirror Netflix",
    version: 1,
    description: "Port of the NetflixMirror Netflix provider with mirror switching.",
    languages: ["en", "hi", "ta", "te", "ml", "kn"],
    categories: ["Movies", "Series", "Anime"],
    baseUrl: "https://net52.cc",
    domains: [
      { name: "net52.cc", url: "https://net52.cc" },
      { name: "net22.cc", url: "https://net22.cc" }
    ],
    runtime: {
      key: "netflix",
      displayName: "Netflix",
      ...
      contentBases: ["https://net52.cc", "https://net22.cc"],
      homeBases: ["https://net22.cc", "https://net52.cc"],
      streamBases: ["https://net52.cc", "https://net22.cc"],
      cookieBases: ["https://net52.cc", "https://net22.cc"],
      tokenBases: ["https://net22.cc", "https://net52.cc"],
      ...
      episodePosterUrl: "https://imgcdn.kim/epimg/150/{id}.jpg",
      refererPath: "/home"
    }
  },
  {
    folder: "netmirror-primevideo",
    packageName: "com.igris.repo.netmirrorprimevideo",
    name: "NetMirror PrimeVideo",
    version: 1,
    description: "Port of the NetflixMirror PrimeVideo provider with mirror switching.",
    languages: ["en", "hi", "ta", "te", "ml", "kn"],
    categories: ["Movies", "Series", "Anime"],
    baseUrl: "https://net52.cc",
    domains: [
    ...
    runtime: {
      ...
      defaultBaseUrl: "https://net52.cc",
      contentBases: ["https://net52.cc", "https://net22.cc"],
      homeBases: ["https://net52.cc", "https://net22.cc"],
      streamBases: ["https://net52.cc", "https://net22.cc"],
      cookieBases: ["https://net52.cc", "https://net22.cc"],
      tokenBases: [],
      homeMode: "prime_json",
  ...
  {
    folder: "netmirror-jiohotstar",
    packageName: "com.igris.repo.netmirrorjiohotstar",
    name: "NetMirror JioHotstar",
    version: 1,
    description: "Port of the NetflixMirror JioHotstar provider with mirror switching.",
    languages: ["en", "hi", "ta", "te", "ml", "kn"],
    categories: ["Movies", "Series", "Anime"],
    baseUrl: "https://net22.cc",
    domains: [
      { name: "net22.cc", url: "https://net22.cc" },
      { name: "net52.cc", url: "https://net52.cc" }
    ],
    runtime: {
      ...
      contentBases: ["https://net22.cc", "https://net52.cc"],
      homeBases: ["https://net22.cc", "https://net52.cc"],
      streamBases: ["https://net52.cc", "https://net22.cc"],
      cookieBases: ["https://net52.cc", "https://net22.cc"],
      tokenBases: [],
      homeMode: "jio_html",
      homePath: "/mobile/home",
      searchPath: "/mobile/hs/search.php",
      detailPath: "/mobile/hs/post.php",
      ...
      episodePosterUrl: "https://imgcdn.kim/hsepimg/150/{id}.jpg",
      refererPath: "/home"
    }
  }
];
...
function renderPluginJson(plugin) {
...
function renderPluginJs(plugin) {
  const configJson = JSON.stringify(plugin.runtime, null, 2);
  return `(function () {
    "use strict";
...
for (const plugin of PLUGINS) {
  const pluginDir = path.join(STAGE_DIR, plugin.folder);
  ensureDir(pluginDir);
  writeFile(path.join(pluginDir, "plugin.json"), renderPluginJson(plugin));
  writeFile(path.join(pluginDir, "plugin.js"), renderPluginJs(plugin));
}

console.log("Generated stage:", STAGE_DIR);
