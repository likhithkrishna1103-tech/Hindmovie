...
public class e extends DefaultHandler implements w2.q {

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    public final XmlPullParserFactory f6851v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    public static final Pattern f6847w = Pattern.compile("(\\d+)(?:/(\\d+))?");

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    public static final Pattern f6848x = Pattern.compile("CC([1-4])=.*");

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    public static final Pattern f6849y = Pattern.compile("([1-9]|[1-5][0-9]|6[0-3])=.*");

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    public static final int[] f6850z = {2, 1, 2, 2, 2, 2, 1, 2, 2, 1, 1, 1, 1, 2, 1, 1, 2, 2, 2};
    public static final int[] A = {-1, 1, 2, 3, 4, 5, 6, 8, 2, 3, 4, 7, 8, 24, 8, 12, 10, 12, 14, 12, 14};

    public e() {
        try {
            this.f6851v = XmlPullParserFactory.newInstance();
        } catch (XmlPullParserException e9) {
            throw new RuntimeException("Couldn't create XmlPullParserFactory instance", e9);
        }
    }

    public static long a(ArrayList arrayList, long j4, long j7, int i, long j10) {
        int i10;
        if (i >= 0) {
            i10 = i + 1;
        } else {
            int i11 = a0.f14551a;
            i10 = (int) ((((j10 - j4) + j7) - 1) / j7);
        }
        for (int i12 = 0; i12 < i10; i12++) {
            arrayList.add(new q(j4, j7));
            j4 += j7;
        }
        return j4;
    }
    ...
    */
    public static int c(org.xmlpull.v1.XmlPullParser r12, java.lang.String r13) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: k2.e.c(org.xmlpull.v1.XmlPullParser, java.lang.String):int");
    }
    ...
    public static ArrayList e(XmlPullParser xmlPullParser, ArrayList arrayList, boolean z10) throws XmlPullParserException, IOException {
        ...
        int i = attributeValue != null ? Integer.parseInt(attributeValue) : z10 ? 1 : Integer.MIN_VALUE;
        ...
        } while (!y1.d.l(xmlPullParser, "BaseURL"));
        if (text != null && y1.b.j(text)[0] != -1) {
            if (attributeValue3 == null) {
                attributeValue3 = text;
            }
            return ua.q.p(new b(i, i10, text, attributeValue3));
        }
        ArrayList arrayList2 = new ArrayList();
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            b bVar = (b) arrayList.get(i11);
            String strN = y1.b.n(bVar.f6827a, text);
    ...
    public static f i(XmlPullParser xmlPullParser, String str) throws XmlPullParserException, IOException {
        ...
        do {
            xmlPullParser.next();
        } while (!y1.d.l(xmlPullParser, str));
    ...
    public static long j(XmlPullParser xmlPullParser, String str, long j4) {
        ...
        Matcher matcher = a0.f.matcher(attributeValue);
        if (!matcher.matches()) {
        ...
        long j7 = (long) ((d14 + (strGroup6 != null ? Double.parseDouble(strGroup6) : 0.0d)) * 1000.0d);
    ...
    public static float k(XmlPullParser xmlPullParser, float f) {
        ...
        if (attributeValue != null) {
            Matcher matcher = f6847w.matcher(attributeValue);
            if (matcher.matches()) {
    ...
    public static j m(XmlPullParser xmlPullParser, String str, String str2) {
        ...
        if (attributeValue2 != null) {
            ...
            if (strArrSplit.length == 2) {
                j7 = (Long.parseLong(strArrSplit[1]) - j4) + 1;
            }
            return new j(j4, j7, attributeValue);
        }
        j4 = 0;
        j7 = -1;
        return new j(j4, j7, attributeValue);
    ...
    public static int o(ArrayList arrayList) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            if (android.support.v4.media.session.b.j("http://dashif.org/guidelines/trickmode", ((f) arrayList.get(i10)).f6852a)) {
                i = 16384;
            }
        }
        return i;
    ...
    public static r p(XmlPullParser xmlPullParser, r rVar) throws XmlPullParserException, IOException {
        ...
        long j14 = j13;
        long j15 = j12;
        j jVarM = rVar != null ? rVar.f6889a : null;
        while (true) {
            xmlPullParser.next();
            if (y1.d.m(xmlPullParser, "Initialization")) {
                jVarM = m(xmlPullParser, "sourceURL", "range");
            } else {
                b(xmlPullParser);
            }
            j jVar = jVarM;
            if (y1.d.l(xmlPullParser, "SegmentBase")) {
                return new r(jVar, j7, j11, j15, j14);
            }
            jVarM = jVar;
        }
    }

    public static o q(XmlPullParser xmlPullParser, o oVar, long j4, long j7, long j10, long j11, long j12) throws XmlPullParserException, IOException {
        long j13 = oVar != null ? oVar.f6890b : 1L;
        List arrayList = null;
        String attributeValue = xmlPullParser.getAttributeValue(null, "timescale");
        if (attributeValue != null) {
        ...
        do {
            ...
            if (y1.d.m(xmlPullParser, "Initialization")) {
                jVarM = m(xmlPullParser, "sourceURL", "range");
            } else if (y1.d.m(xmlPullParser, "SegmentTimeline")) {
                listS = s(xmlPullParser, j14, j7);
            } else if (y1.d.m(xmlPullParser, "SegmentURL")) {
                if (arrayList == null) {
        ...
        } while (!y1.d.l(xmlPullParser, "SegmentList"));
        if (oVar != null) {
            if (jVarM == null) {
                jVarM = oVar.f6889a;
            }
            ...
            if (arrayList == null) {
                arrayList = oVar.f6881j;
            }
        }
        return new o(jVarM, j14, j16, j20, j18, listS, j22, arrayList, a0.O(j12), a0.O(j4));
    }

    public static p r(XmlPullParser xmlPullParser, p pVar, List list, long j4, long j7, long j10, long j11, long j12) throws XmlPullParserException, IOException {
        long j13;
        long j14 = pVar != null ? pVar.f6890b : 1L;
        j jVarM = null;
        String attributeValue = xmlPullParser.getAttributeValue(null, "timescale");
        if (attributeValue != null) {
        ...
        long j15 = j14;
        long j16 = pVar != null ? pVar.f6891c : 0L;
        String attributeValue2 = xmlPullParser.getAttributeValue(null, "presentationTimeOffset");
        if (attributeValue2 != null) {
            j16 = Long.parseLong(attributeValue2);
        }
        long j17 = j16;
        long j18 = pVar != null ? pVar.f6878e : -9223372036854775807L;
        String attributeValue3 = xmlPullParser.getAttributeValue(null, "duration");
        if (attributeValue3 != null) {
            j18 = Long.parseLong(attributeValue3);
        }
        long j19 = j18;
        long j20 = pVar != null ? pVar.f6877d : 1L;
        String attributeValue4 = xmlPullParser.getAttributeValue(null, "startNumber");
        if (attributeValue4 != null) {
        ...
        while (true) {
            ...
            f fVar = (f) list.get(i);
            if (android.support.v4.media.session.b.j("http://dashif.org/guidelines/last-segment-number", fVar.f6852a)) {
                j13 = Long.parseLong(fVar.f6853b);
                break;
            }
            i++;
        }
        ...
        v vVarT = t(xmlPullParser, "media", pVar != null ? pVar.f6883k : null);
        v vVarT2 = t(xmlPullParser, "initialization", pVar != null ? pVar.f6882j : null);
        List listS = null;
        do {
            xmlPullParser.next();
            if (y1.d.m(xmlPullParser, "Initialization")) {
                ...
                listS = s(xmlPullParser, j15, j7);
            } else {
                b(xmlPullParser);
            }
        } while (!y1.d.l(xmlPullParser, "SegmentTemplate"));
        if (pVar != null) {
            if (jVarM == null) {
                jVarM = pVar.f6889a;
            }
        ...
        return new p(jVarM, j15, j17, j21, j22, j19, listS, j24, vVarT2, vVarT, a0.O(j12), a0.O(j4));
    }

    public static ArrayList s(XmlPullParser xmlPullParser, long j4, long j7) throws XmlPullParserException, IOException {
        long j10;
        ...
        } while (!y1.d.l(xmlPullParser, "SegmentTimeline"));
        if (z10) {
            int i11 = a0.f14551a;
            a(arrayList, jA, j11, i, a0.W(j7, j4, 1000L, RoundingMode.DOWN));
        }
        return arrayList;
    }

    /* JADX WARN: Failed to find 'out' block for switch in B:30:0x00ff. Please report as an issue. */
    public static v t(XmlPullParser xmlPullParser, String str, v vVar) {
        String strSubstring;
        String attributeValue = xmlPullParser.getAttributeValue(null, str);
        if (attributeValue == null) {
            return vVar;
        ...
        return new v(arrayList, arrayList2, arrayList3, 25);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public android.util.Pair f(org.xmlpull.v1.XmlPullParser r15) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            Method dump skipped, instruction units count: 410
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: k2.e.f(org.xmlpull.v1.XmlPullParser):android.util.Pair");
    }

    @Override // w2.q
    public final Object g(Uri uri, b2.m mVar) throws n0 {
        try {
            XmlPullParser xmlPullParserNewPullParser = this.f6851v.newPullParser();
            xmlPullParserNewPullParser.setInput(mVar, null);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final k2.c l(org.xmlpull.v1.XmlPullParser r165, android.net.Uri r166) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            Method dump skipped, instruction units count: 5018
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: k2.e.l(org.xmlpull.v1.XmlPullParser, android.net.Uri):k2.c");
    }
}
