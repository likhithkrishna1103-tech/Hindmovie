...
public final class q extends a.a {
    ...
    public void o(h0 h0Var, h0 h0Var2, Window window, View view, boolean z10, boolean z11) {
        ...
        ge.i.e(view, "view");
        w8.e.l(window, false);
        window.setStatusBarColor(z10 ? h0Var.f1958b : h0Var.f1957a);
        window.setNavigationBarColor(h0Var2.f1958b);
        l4.a aVar = new l4.a(view);
        int i = Build.VERSION.SDK_INT;
        (i >= 35 ? new t1(window, aVar) : i >= 30 ? new s1(window, aVar) : i >= 26 ? new r1(window, aVar) : new q1(window, aVar)).A(!z10);
    }
}
