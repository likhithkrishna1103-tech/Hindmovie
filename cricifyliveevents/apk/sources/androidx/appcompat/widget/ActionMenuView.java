...
public class ActionMenuView extends y1 implements j, y {
    ...
    public final boolean c(n.m mVar) {
        return this.K.q(mVar, null, 0);
    }

    @Override // o.y1, android.view.ViewGroup
    ...
    public Menu getMenu() {
        if (this.K == null) {
            ...
            this.K = kVar;
            kVar.f8523e = new l4.a((Object) this);
    ...
    public final void onLayout(boolean z10, int i, int i10, int i11, int i12) {
        ...
        if (z12) {
            ...
            for (int i22 = 0; i22 < childCount; i22++) {
                ...
                if (childAt3.getVisibility() != 8 && !mVar2.f9269a) {
        ...
        for (int i25 = 0; i25 < childCount; i25++) {
            ...
            if (childAt4.getVisibility() != 8 && !mVar3.f9269a) {
    ...
    public final void onMeasure(int i, int i10) {
        ...
        if (this.R && (kVar = this.K) != null && size != this.S) {
            this.S = size;
            kVar.p(true);
        }
        int childCount = getChildCount();
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                mVar2.f9273e = z13 && !TextUtils.isEmpty(((ActionMenuItemView) childAt).getText());
                int i26 = mVar2.f9269a ? 1 : i18;
        ...
        if (i31 > 0 && j4 != 0 && (i31 < i21 - 1 || z21 || iMax2 > 1)) {
            ...
            if (!z21) {
                if ((j4 & 1) != 0 && !((m) getChildAt(0).getLayoutParams()).f9273e) {
                    fBitCount -= 0.5f;
                }
                int i39 = childCount2 - 1;
                if ((j4 & ((long) (1 << i39))) != 0 && !((m) getChildAt(i39).getLayoutParams()).f9273e) {
                    fBitCount -= 0.5f;
                }
            }
        ...
        if (z17) {
            for (int i42 = 0; i42 < childCount2; i42++) {
                ...
                if (mVar7.f) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((mVar7.f9270b * i30) + mVar7.f9271c, 1073741824), childMeasureSpec);
                }
            }
        }
    ...
    public void setPresenter(o.k kVar) {
        this.O = kVar;
        kVar.C = this;
        this.K = kVar.f9251x;
    }
